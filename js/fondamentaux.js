...
const FONDAMENTAUX = [
  ...
  },
  {
    ...
    emoji: "🥚",
    famille: "Froid, gras & sécurité",
    accroche: "On monte une mayonnaise avec un jaune cru : le risque de salmonellose est faible en Europe, il ne disparaît pas, et il se joue presque entièrement sur la fraîcheur de l'œuf et sur le délai avant de servir.",
    pourquoi: "Salmonella enterica vit dans le tube digestif des volailles. Elle arrive donc d'abord sur la coquille, au moment de la ponte ou dans le nid : c'est de très loin l'événement de contamination le plus fréquent. Une seconde voie existe, plus rare : une poule infectée, presque toujours par le sérovar Enteritidis, qui colonise l'appareil reproducteur et dépose la bactérie dans l'œuf en formation, avant que la coquille se referme. L'œuf est alors contaminé de l'intérieur, et aucune propreté de cuisine n'y change rien. Laquelle des deux voies fait le plus de malades n'est pas tranché : la première est la plus courante, la seconde met la bactérie là où l'on ne peut plus l'atteindre.\n\nCette contamination interne compte peu de bactéries — quelques cellules, parfois quelques dizaines — et elles se logent le plus souvent dans le blanc, qui est un milieu hostile : l'ovotransferrine y séquestre le fer dont elles ont besoin pour se multiplier. Elles y survivent sans y croître. Ce qui change tout, c'est le temps et la chaleur. En vieillissant, la membrane vitelline qui entoure le jaune devient perméable ; les bactéries passent dans le jaune, milieu riche et sans défense, et s'y multiplient vite. Un œuf récent gardé au frais et un œuf ancien gardé au chaud ne portent pas le même risque, alors qu'ils sont partis du même état. Notez au passage que le froid ne joue pas ici le rôle qu'il joue pour le poisson cru. La congélation tue les larves d'Anisakis ; elle ne tue pas les salmonelles, qui survivent des mois à l'état congelé et repartent au dégel. Il n'existe donc pas, pour l'œuf, de congélation qui règle la question. Et congeler un œuf en coquille ne le désinfecte pas, cela le fend.\n\nÀ l'échelle européenne, la chose est prise au sérieux depuis longtemps. Des programmes nationaux encadrent les troupeaux de pondeuses depuis 2008, avec dépistage régulier et, selon les pays, vaccination contre Salmonella Enteritidis et Typhimurium. L'objectif se compte en pourcentage de troupeaux positifs : au plus 2 % des troupeaux adultes de pondeuses, fixé par le règlement 517/2011 et toujours la seule cible en vigueur. Le 1 % que l'on lit parfois est la cible des autres populations de volailles ; pour les pondeuses, l'EFSA l'a évalué comme un objectif possible, il n'a jamais été adopté. La vaccination, de même, n'est pas une obligation européenne uniforme : elle s'impose aux États membres dont la prévalence dépasse 10 %, et elle est obligatoire en France. Le résultat est un risque bas et non nul. En 2024, l'Union a enregistré 79 703 salmonelloses humaines confirmées, soit 18,6 pour 100 000 habitants, et le rapport EFSA-ECDC désigne le couple Salmonella et œufs comme la paire agent-aliment la plus préoccupante.\n\nCe qui est solide : la voie de contamination, l'hostilité du blanc, l'accélération avec l'âge et la chaleur, l'efficacité de la cuisson. Ce qui l'est moins, c'est précisément ce qu'on voudrait savoir — la probabilité qu'un œuf pris au hasard dans une boîte européenne porte des salmonelles dans son contenu. Les enquêtes portent sur des troupeaux, pas sur des boîtes de six. Et les durées de conservation d'une préparation crue relèvent de la prudence administrative plus que de la mesure. D'où la certitude partielle de cette fiche : le mécanisme est clair, les chiffres qui compteraient pour vous ne le sont pas.",
    certitude: "partiel",
    cas: [
      { q: "Sur la coquille, ou dans l'œuf",
        r: "Les deux, mais pas dans les mêmes proportions et sans les mêmes recours. La coquille est la voie courante, et c'est celle que vous tenez. Cassez l'œuf sur une surface plate plutôt que sur le bord du bol : le geste est reconnu pour donner moins d'éclats, et l'idée qu'il enfonce moins l'extérieur de la coquille dans le blanc est plausible sans avoir été mesurée. Ne reposez pas les demi-coquilles là où vous travaillez. Ne repêchez pas un fragment tombé avec le doigt qui replongera dans la sauce : prenez une demi-coquille propre ou une cuillère, et jetez ce que vous récupérez. Écartez d'emblée un œuf fêlé ou souillé, qui n'a rien à faire dans une préparation crue. Et lavez-vous les mains, le bol et le fouet dès que les coquilles sont à la poubelle : c'est le trajet coquille, doigts, aliment qui fait le plus de cas, bien plus que l'œuf lui-même. La voie interne, elle, est rare et ne se corrige par aucun geste : c'est elle qui fait qu'une préparation à l'œuf cru n'est jamais tout à fait sans risque, même conduite proprement." },
      { q: "Quel risque, réellement",
        r: "Faible, et impossible à chiffrer honnêtement par œuf. Ce que l'on sait : 79 703 salmonelloses confirmées dans l'Union en 2024, et le couple Salmonella et œufs en tête des paires agent-aliment préoccupantes. Ce que l'on ignore : quelle part des œufs vendus porte des bactéries dans son contenu. Le chiffre d'un œuf sur vingt mille circule beaucoup ; il vient d'une estimation américaine de la fin des années 1990 et ne dit rien d'un œuf européen d'aujourd'hui, produit sous dépistage obligatoire et, le plus souvent, par des pondeuses vaccinées. Retenez l'ordre de grandeur plutôt que le nombre : un foyer qui fait de la mayonnaise maison quelques fois par an prend un risque petit, jamais nul." },
      { q: "Combien de temps se garde une préparation crue",
        r: "Vingt-quatre heures au réfrigérateur : c'est la limite retenue par l'Anses, et c'est une limite d'usage raisonnable, pas un seuil mesuré. Le froid ne stérilise rien. Selon les souches, la salmonelle cesse de se multiplier entre 5 et 7 °C environ : un réfrigérateur qui tient 4 °C bloque donc bien la croissance, mais il ne tue pas, et elle y survit des jours. Encore faut-il que la température soit réelle. La contre-porte est la zone la plus chaude et la plus instable de l'appareil, et les relevés faits chez des particuliers trouvent couramment des réfrigérateurs entiers au-dessus de 6 °C, où la multiplication repart lentement. La température de la vôtre, personne ne la connaît : un thermomètre posé dedans en dit plus que n'importe quelle moyenne. Au-delà, on ne franchit pas de seuil brutal : on cumule les réchauffements, les allers-retours du bocal sur la table, et le temps passé au-dessus de 7 °C." },
      { q: "Le vinaigre et le citron protègent-ils",
        r: "Beaucoup moins qu'on ne l'imagine. Les protocoles qui rendent une mayonnaise crue véritablement sûre demandent un pH de 4,1 au plus, obtenu au vinaigre — l'acide acétique est nettement plus bactéricide que l'acide citrique du citron —, suivi d'un séjour de vingt-quatre à soixante-douze heures entre 18 et 23 °C pour que la destruction ait lieu. Ce protocole vient de l'industrie des sauces ; il n'a jamais été pensé pour une cuisine. Une mayonnaise de cuisine, une cuillère à café de vinaigre pour un jaune et 20 cl d'huile, reste au-dessus de ce pH. De combien, cela dépend de la dose d'acide, et personne ne le mesure chez soi : l'acidité y assaisonne, elle ne désinfecte pas. L'effet est de surcroît paradoxal, puisque c'est à température ambiante que l'acide tue vite et au froid qu'il ne fait presque rien. N'en tirez surtout pas la conclusion inverse : votre mayonnaise n'étant pas acidifiée à 4,1, la laisser tiédir ne la nettoie pas, cela lui permet seulement de croître. Le réfrigérateur reste sa place." },
      { q: "Qui devrait s'abstenir",
        r: "Les femmes enceintes, les nourrissons et les jeunes enfants, les personnes âgées et les immunodéprimés — chimiothérapie, greffe, traitement immunosuppresseur. Deux choses changent pour eux, et non une seule. La dose qui suffit à les rendre malades est plus basse : chez un nourrisson, chez une personne âgée, chez quelqu'un qui prend un antiacide, l'acidité de l'estomac filtre moins bien ce qui descend. Et la suite est plus lourde : chez un adulte en bonne santé une salmonellose est quelques jours désagréables ; dans ces groupes elle passe plus volontiers dans le sang et conduit à l'hôpital. La règle ne se négocie pas : préparation cuite, ou ovoproduit pasteurisé du commerce. Cuite veut dire un jaune franchement pris — le Food Code américain retient 63 °C pendant quinze secondes pour un œuf cassé et servi aussitôt, 68 °C pendant dix-sept secondes pour une préparation —, ce qu'un œuf mollet et une omelette baveuse n'atteignent pas. Et c'est l'un des rares cas où la mayonnaise du commerce, faite d'œuf pasteurisé et acidifiée, est le bon choix." },
      { q: "L'œuf pasteurisé, et la pasteurisation à la maison",
        r: "L'ovoproduit pasteurisé — brique de jaune ou d'œuf entier liquide, au rayon frais — est la solution simple et la seule réellement garantie. L'œuf pasteurisé en coquille existe : quelques producteurs le distribuent aux États-Unis, où il reste une part marginale du rayon, et il est rare en France. À la maison, la chose est praticable, à une condition : un thermoplongeur. Comptez environ 57 °C pendant soixante-quinze minutes, œufs entiers et sans la moindre fêlure, posés en une seule couche, puis un refroidissement immédiat et un retour au réfrigérateur. La marge est étroite, car le blanc commence à prendre vers 62 °C : dès 57 °C il se trouble un peu et monte nettement moins bien en neige. Un jaune destiné à une mayonnaise le supporte sans dommage, un blanc destiné à une meringue beaucoup moins. Sachez surtout ce que ce geste n'est pas. L'industrie valide son procédé sur des lots et le vérifie ; chez vous, rien ne dit que le bain était juste, ni que le cœur de l'œuf a suivi, ni de combien la charge a baissé. Une pasteurisation domestique abaisse le risque, elle ne l'annule pas, et elle ne remplace pas l'ovoproduit du commerce pour les personnes à qui le cas précédent conseille de s'abstenir." },
      { q: "Lavés ou non, réfrigérés ou non",
        r: "Deux systèmes cohérents, qu'il ne faut pas mélanger. En Europe, l'œuf n'est pas lavé : la cuticule déposée à la ponte bouche les pores et fait barrière, on la garde, et l'on agit à la source en vaccinant et en surveillant les pondeuses. L'œuf se vend donc à température ambiante. Aux États-Unis, il est lavé et désinfecté au centre de conditionnement, ce qui emporte la cuticule ; la coquille devient perméable, et la réfrigération continue, de la ferme au magasin, devient obligatoire. Aucun des deux n'a tort. Ce qui serait faux, c'est de laver ses œufs européens avant de les ranger : on retire la barrière sans rien mettre à la place." },
      { q: "Comment les garder chez soi, et quel œuf pour du cru",
        r: "Choisissez une température et n'en changez plus. Un œuf sorti du froid et laissé se réchauffer se couvre de condensation, et ce film d'eau est justement ce qui peut entraîner à travers les pores ce qui se trouve sur la coquille : c'est le raisonnement qui fonde la règle européenne, et il vaut aussi dans une cuisine. Les allers-retours sont donc le pire régime. Pour une préparation crue, prenez un œuf récent : les neuf premiers jours après la ponte, la période dite extra-frais. La date de consommation recommandée imprimée court jusqu'à vingt-huit jours après la ponte, mais elle vise un œuf cuit. Quant au test de flottaison, il mesure la chambre à air, donc l'âge et l'eau perdue : il vous dit si l'œuf est vieux, jamais s'il est contaminé. C'est aussi la réponse à la recette de mayonnaise du carnet : la fiche sur l'émulsion l'a déjà établi, ce n'est pas la température qui fait monter une sauce, et sur un œuf sorti du froid c'est exactement le régime à éviter. Si vos œufs vivent au réfrigérateur, cassez le jaune en sortant l'œuf. S'ils vivent sur le plan de travail, ce qui est l'usage européen, la question ne se pose pas." }
    ],
    reperes: [
      "Un œuf fêlé, souillé ou que l'on a lavé ne va pas dans une préparation crue : cuisson complète, ou poubelle.",
      "Préparation à l'œuf cru : servie dans la journée. La recommandation est de 24 heures au réfrigérateur, entre 0 et 4 °C. Les deux jours que l'on lit souvent sont un dépassement assumé, jamais une seconde recommandation.",
      "La salmonelle cesse de se multiplier entre 5 et 7 °C selon la souche, et elle n'y meurt pas : le froid suspend, il ne corrige rien.",
      "Acidité : les protocoles éprouvés demandent pH 4,1 ou moins, au vinaigre plutôt qu'au citron. Une mayonnaise de cuisine reste bien au-dessus — l'ordre de grandeur est sûr, le chiffre exact dépend de la dose.",
      "Pasteurisation en coquille : environ 57 °C pendant 75 minutes, puis refroidissement immédiat. Le blanc se trouble et monte mal ensuite.",
      "Œuf destiné au cru : les 9 premiers jours après la ponte. La date de consommation recommandée, à 28 jours, vise l'œuf cuit."
    ],
    piege: "Garder la mayonnaise du dimanche pour le mardi parce qu'elle a l'air intacte. Une préparation à l'œuf cru ne donne aucun signe : à ces quantités de bactéries, elle ne tourne pas, elle ne sent rien et elle ne se sépare pas. Le froid a seulement suspendu ce qui s'y trouvait, et le bocal ressorti à table le remet en marche. On jette au bout de vingt-quatre heures parce qu'on a noté l'heure sur le couvercle, jamais parce qu'on a goûté.",
    source: "EFSA et ECDC, « The European Union One Health 2024 Zoonoses Report », EFSA Journal, 2025 ; Keerthirathne, Ross, Fallowfield et Whiley, « A Review of Temperature, pH, and Other Factors that Influence the Survival of Salmonella in Mayonnaise and Other Raw Egg Products », Pathogens 5 (2016) ; règlement (UE) 517/2011 sur la réduction des salmonelles chez les poules pondeuses."
  }
];
